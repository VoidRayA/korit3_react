  ...
  return (
    <main className="main"> 
      <section className="section">
        ...
        <p>
          안녕하세요, 저는 KoreaITAcademy 국비 과정으로 Full Stack 과정을 수료한 유지현이라고 합니다. 최근에는 React를 이용한 프론트엔드에도 흥미를 가지고 있어 Full Stack 개발자 과정에 지망하게되었습니다. 문제 해결과 클린 코드를 중시하며, 팀원 간 협업을 통해 가치를 만들어 내는 것을 좋아합니다.
        </p>
      </section>
      <section className="section">
        ...
        <ul>
          ...
          <li>
            <strong>2011.03 - 2018.02</strong> | 동서대학교 일어일문학과 졸업<br/>
            - React Library<br/>
            - Spring Framework<br/>
      ...
      <section className="section">
        ...
        <p>
          <strong>Lnaguages : </strong> Java, JavaScript, TypeScript <br/>
